...
It has since been surpassed in its diameter by the the Five hundred meter
Apeture Spherical Telescope (FAST) in China, as well as by telescope arrays
...
<img src="{{ site.baseurl }}/assets/mwa.png">
...
light was generated. This is seen in the coloration of the map, where the nearby
hydrogen is represented in green and orange while the redshifted hydrogen is
seen in violet.

While the 21 cm line radio telescopes are only capable of viewing neutral
hydrogen due to the physics of that particular transition, they are still very
useful for understanding the morphology of the early universe, as hydrogen is
not only the primary component of the universe but also the fuel that stars need
to burn in order to emit light. Much as there is a tendency to see smoke where
there is fire, astronomers can see accumulations of hydrogen with radio
telescopes as a way of predicting where galaxies and stars may be coalescing.
...
Taking pictures of stars is perhaps the most obvious and straightforward way to
confirm the existence of stars, and it is this task that is not possible using
radio telescopes which are tuned to the much lower 21 cm emissions. The actual
imaging of galaxies and their stars serves as a useful direct check as to the
prevalence of stars and order in the early universe which can otherwise only be
infered by the 21cm family of telescopes.
...
In this glimpse we've gotten of the EoR we see our own birth: the transformation
of a smooth universe into a clumpy, nonhomogeneous universe with the energy flow
that makes life possible. Not only does this period of our history show the
creation of our universe, but also the stars born of it would create the first
heavy atoms which would go on to build the Earth and Solar System we live in
today.

Our understanding of the Epoch of Reionization is rapidly emerging, and with any
luck, soon we will be able to pry back the lid a little more and capture this
period in the Universe's history a little better. With any luck, we'll soon be
